    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
        <div>
          ...
          <p className="text-slate-400 text-sm mt-0.5">{total} clientes registrados</p>
        </div>
      ...
      <Modal open={modalOpen} onClose={cerrar} title={editando ? "Editar cliente" : "Nuevo cliente"}>
        ...
        >
          ...
          {apiError && (
            <p className="text-sm text-red-400 bg-red-500/10 border border-red-500/20 rounded-lg px-3 py-2">{apiError}</p>
          )}
